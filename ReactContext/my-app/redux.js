/// contoh redux terpisah dari project diatas
// memangil redux
const redux = require("redux");
const createStore = redux.createStore;

/// install react redux  { npm add react-redux }
const initialState = {
  value: 0,
  age: 17,
};
...
// - sebagai notifikasi bahwa state telah berubah.
store.subscribe(() => {
